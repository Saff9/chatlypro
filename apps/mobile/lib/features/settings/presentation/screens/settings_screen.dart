          ...
          content: Column(
            ...
            children: [
              ...
              _limitInfoRow(
                ...
                description:
                    'Best-effort local deletion. Due to flash wear-leveling, OS caches, filesystem journaling, backups, and database internals, deleted data may still be recoverable by forensic tools.',
              ),
              const SizedBox(height: 16),
              Container(
